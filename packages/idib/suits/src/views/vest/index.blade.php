                                    ...
                                    @foreach($items as $k => $item)
                                        <tr data-row-id="u0" class="mdc-data-table__row">
                                            ...
                                            <td class="mdc-data-table__cell">
                                                ...
                                                <a href="{{ route('admin.suits.vests.style-attributes', [$item->id]) }}" title="Accent Attributes" class="mdc-button mdc-button--raised icon-button filled-button--secondary mdc-ripple-upgraded">
