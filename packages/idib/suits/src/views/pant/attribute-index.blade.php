                ...
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                    <div class="mdc-card p-0">
                        <div class="col-12 row">
                            <h6 style="float: left;" class="card-title card-padding mb-0 p-3">Pant Styles</h6>
                            <h6 style="float: right;" class="card-title card-padding mb-0 p-3">
                                <a href="{{ route('admin.suits.pants') }}" class="mdc-button mdc-button--raised icon-button filled-button--secondary mdc-ripple-upgraded" title="Back To Accents">
