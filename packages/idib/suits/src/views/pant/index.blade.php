                ...
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                    <div class="mdc-card p-0">
                        <div class="col-12 row">
                            <h6 style="float: left;" class="card-title card-padding mb-0 p-3">Pant</h6>
                                    ...
                                    @foreach($items as $k => $item)
                                        <tr data-row-id="u0" class="mdc-data-table__row">
                                            ...
                                            <td class="mdc-data-table__cell">
                                                ...
                                                <a href="{{ route('admin.suits.pants.style-attributes', [$item->id]) }}" title="Accent Attributes" class="mdc-button mdc-button--raised icon-button filled-button--secondary mdc-ripple-upgraded">
