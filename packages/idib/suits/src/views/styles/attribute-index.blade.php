                ...
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                    <div class="mdc-card p-0">
                        <div class="col-12 row">
                            <h6 style="float: left;" class="card-title card-padding mb-0 p-3">Jackets Styles</h6>
                            <h6 style="float: right;" class="card-title card-padding mb-0 p-3">
                                <a href="{{ route('admin.suits.jackets') }}" class="mdc-button mdc-button--raised icon-button filled-button--secondary mdc-ripple-upgraded" title="Back To Accents">
                        ...
                        <div class="mdc-data-table">
                            <table class="mdc-data-table__table" aria-label="Dessert calories">
                                ...
                                <tr class="mdc-data-table__header-row">
                                    <th class="mdc-data-table__header-cell" role="columnheader" scope="col">Style Type</th>
                                ...
                                @if(isset($items))
                                    @foreach($items as $k => $item)
                                        <tr data-row-id="u0" class="mdc-data-table__row">
                                            <td class="mdc-data-table__cell">{{ $item->parent }}</td>
                                            ...
                                            <td class="mdc-data-table__cell">
                                                <a href="{{ route('admin.suits.jackets.edit', [$id, $item->id]) }}" class="mdc-button mdc-button--raised icon-button mdc-ripple-upgraded">
