                    ...
                    <div class="mdc-card p-0">
                        <div class="col-12 row">
                            ...
                            <h6 style="float: right;" class="card-title card-padding mb-0 p-2">
                                <a href="{{ route('admin.suits.categories') }}" class="mdc-button mdc-button--raised icon-button filled-button--secondary mdc-ripple-upgraded" title="Back To Categories">
                                    <i class="material-icons mdc-button__icon">arrow_back</i>
                                </a>
                                <a href="{{ route('admin.suits.categories.sub-categories.add', [$id]) }}" class="mdc-button mdc-button--raised icon-button mdc-ripple-upgraded" title="Add Sub Category">
                                ...
                                @if(isset($items))
                                    @foreach($items as $k => $item)
                                        <tr data-row-id="u0" class="mdc-data-table__row">
                                            ...
                                            <td class="mdc-data-table__cell">{{ $item->parent->name }}</td>
                                            ...
                                            <td class="mdc-data-table__cell">
                                                <a href="{{ route('admin.suits.categories.sub-categories.edit', [$id, $item->id]) }}" title="Edit" class="mdc-button mdc-button--raised icon-button mdc-ripple-upgraded">
                                                    <i class="material-icons mdc-button__icon">edit</i>
                                                </a>
                                                <a href="{{ route('admin.suits.categories.sub-categories.delete', [$id, $item->id]) }}" title="Sub Categories" class="mdc-button mdc-button--raised icon-button filled-button--secondary mdc-ripple-upgraded">
