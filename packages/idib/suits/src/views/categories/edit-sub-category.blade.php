                ...
                <div class="mdc-layout-grid__cell--span-12">
                    <div class="mdc-card">
                        ...
                        <div class="template-demo">
                            <form name="frm_edit_category" method="post" action="{{ route('admin.suits.categories.sub-categories.update', [$item->parent->id, $item->id]) }}">
                                @csrf
                                <input type="hidden" class="mdc-text-field__input" id="parent_id" name="parent_id" readonly value="{{ $item->parent_id }}"/>
                                <input type="hidden" class="mdc-text-field__input" id="category_id" name="category_id" readonly value="{{ $item->parent->id }}"/>
                                <div class="mdc-layout-grid__inner">
                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                        <div class="mdc-text-field mdc-text-field--outlined">
                                            <input type="text" class="mdc-text-field__input" id="category" name="category" readonly value="{{ $item->parent->name }}"/>
