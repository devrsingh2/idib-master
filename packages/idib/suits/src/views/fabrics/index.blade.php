                    ...
                    <div class="mdc-card p-0">
                        <div class="col-12 row">
                            ...
                            <h6 style="float: right;" class="card-title card-padding mb-0 p-3">
                                <a href="{{ route('admin.suits.fabrics.add') }}" class="mdc-button mdc-button--raised icon-button mdc-ripple-upgraded" title="Add Fabric">
                                ...
                                @if(isset($items))
                                    @foreach($items as $k => $item)
                                        <tr data-row-id="u0" class="mdc-data-table__row">
                                            ...
                                            <td class="mdc-data-table__cell">
                                                <a href="{{ route('admin.suits.fabrics.edit', [$item->id]) }}" class="mdc-button mdc-button--raised icon-button mdc-ripple-upgraded">
