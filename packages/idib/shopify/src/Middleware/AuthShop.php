...
namespace Idib\Shopify\Middleware;
...
use Idib\Shopify\Exceptions\MissingShopDomainException;
use Idib\Shopify\Exceptions\SignatureVerificationException;
...
class AuthShop
{
     ...
     *
     * @param \Illuminate\Http\Request                  $request The request object.
     * @param \Idib\Shopify\Services\ShopSession $session The shop session instance.
     *
     * @throws Exception
     *
     * @return bool|string
