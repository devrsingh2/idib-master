...
use Idib\Shopify\Requests\AuthShop;
use Idib\Shopify\Services\AuthShopHandler;
...
trait AuthControllerTrait
{
     ...
     *
     * @param \Idib\Shopify\Requests\AuthShop $request The incoming request.
     *
    ...
    protected function returnTo()
    {
        ...
        if ($return_to) {
            ...
            toastr()->success('You application installed successfully!');
