...
return [
    ...
    */
        ...
        'prefix' => env('SHOPIFY_APP_PREFIX', 'install'),
    ...
    */
    ...
    'shop_model' => env('SHOPIFY_SHOP_MODEL', '\Idib\Shopify\Models\Shop'),
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'IDIB MASTER'),
    ...
    */
    ...
    | which is Idib\Shopify\BasicShopifyAPI. This option is mainly used for
    | testing and does not need to be changed unless required.
    |
    */

    'api_class' => env('SHOPIFY_API_CLASS', \Idib\Shopify\BasicShopifyAPI::class),
