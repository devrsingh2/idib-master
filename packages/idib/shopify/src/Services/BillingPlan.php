...
class BillingPlan
{
     ...
     *
     * @param \Idib\Shopify\Models\Shop $shop The shop to target for billing.
     * @param \Idib\Shopify\Models\Plan $plan The plan from the database.
     *
     * @return self
     */
