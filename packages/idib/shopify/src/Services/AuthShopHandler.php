...
namespace Idib\Shopify\Services;

use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\URL;
use Idib\Shopify\Events\AppLoggedIn;
use Idib\Shopify\Facades\ShopifyApp;
use Idib\Shopify\Jobs\ScripttagInstaller;
use Idib\Shopify\Jobs\WebhookInstaller;
...
class AuthShopHandler
{
     ...
     *
     * @param \Idib\Shopify\Models\Shop $shop The shop.
     *
     * @return self
     */
