                ...
                <div class="mdc-layout-grid__cell--span-12">
                    <div class="mdc-card">
                        ...
                        <div class="template-demo">
                            <form name="frm_edit_category" method="post" action="{{ route('admin.categories.sub-categories.submit', [$item->product_id, $item->id]) }}">
                                @csrf
                                <input type="hidden" class="mdc-text-field__input" id="product_id" name="product_id" readonly value="{{ $item->product_id }}"/>
                                ...
                                <div class="mdc-layout-grid__inner">
                                    ...
                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop justify-content-end">
                                        <a href="{{ route('admin.categories.sub-categories', [$item->product_id, $item->id]) }}" class="mdc-button mdc-button--raised filled-button--secondary mdc-ripple-upgraded">
